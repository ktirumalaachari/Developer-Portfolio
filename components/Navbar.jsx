...
const Navbar = () => {
  return (
    <nav className="flex p-4 border-b border-gray-200 sticky top-0 bg-white z-50">
      {/* Left Section */}
      <section className="w-2/3 md:w-1/2 p-2 text-xl md:text-2xl font-semibold flex justify-start items-center">
        &lt;K.Tirumala/Achari&gt;
      </section>
      ...
      <Link href="mailto:ktirumalaachari@gmail.com" className="flex items-center px-3 py-2 bg-emerald-700 hover:bg-emerald-800 rounded-md text-white outline-none focus:ring-1 shadow-lg transform active:scale-y-95 transition-transform mx-5" aria-label="Hire Me Button" > 
      <FaBriefcase /> 
